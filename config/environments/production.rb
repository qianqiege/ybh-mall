Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "YBH-mall_#{Rails.env}"
  ...
  # auto rotate log in every day
  # http://ruby-doc.org/stdlib-2.2.0/libdoc/logger/rdoc/Logger.html#method-c-new
