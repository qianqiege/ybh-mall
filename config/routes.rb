Rails.application.routes.draw do
  mount API => '/'
  mount GrapeSwaggerRails::Engine => '/:api_type/docs',
        constraints: { api_type: /(api)/ }
  ...
  namespace :wechat do
    ...
    get '/show_yt_operation_instructions', to: 'home#show_yt_operation_instructions'
  end
