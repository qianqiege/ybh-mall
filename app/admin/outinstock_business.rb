ActiveAdmin.register OutinstockBusiness do

  menu parent: I18n.t( "active_admin.menu.spd")
  permit_params :up_id, :business_number, :out_warehouse, :in_warehouse, :type, :purchase_status, :allocate_status, :datetime, :preparer, :reviewer, :discount, :preferential, :amounts_payable, :is_amended, :order_date, :pay_status
  index do
    selectable_column
    id_column
    column :up_id
...
#form
  form do |spd_business|
    spd_business.inputs do
      ...
      spd_business.input :in_warehouse
